        ...
        <div className="row justify-content-center">
          <div className="col-lg-10 col-xl-8">
            <div className="section-title title-01 mb-70">
              {/* Title */}
              <h2 className="h2-md">الأمان ، البساطة ، السهولة</h2>
              {/* Text */}
              <p className="p-xl">
            ...
            <div className="col-md-7 col-lg-6">
              <div className="txt-block right-column wow fadeInLeft">
                ...
                <div className="txt-box mb-20">
                  {/* Title */}
                  <h5 className="h5-lg">دردش مع أصدقائك بسهولة</h5>
                  {/* Text */}
                  <p className="p-lg">
          ...
          <div className="row d-flex align-items-center">
            ...
            <div className="col-md-7 col-lg-6 order-last order-md-2">
              <div className="txt-block left-column wow fadeInRight">
                {/* Title */}
                <h2 className="h2-xs">اعمل بذكاء مع أتمتة قوية</h2>
                {/* Text */}
                <p className="p-lg">
                ...
                <div className="cbox-2 mt-20 mb-30">
                  ...
                  <div className="cbox-2-txt">
                    <h5 className="h5-xs">إرسال رسائل جماعية</h5>
                    <p className="p-lg">إلى قوائم جهات الاتصال الخاصة بك</p>
                  </div>
                </div>
                {/* CONTENT BOX #2 */}
                <div className="cbox-2">
                  ...
                  {/* Text */}
                  <div className="cbox-2-txt">
                    <h5 className="h5-xs">أقل استخدام للبيانات</h5>
                    <p className="p-lg">مع الرسائل المشفرة</p>
                  </div>
                </div>
              </div>
            </div>{" "}
