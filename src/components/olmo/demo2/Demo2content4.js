					...
					<div className='row d-flex align-items-center'>
						...
						<div className='col-md-7 col-lg-6 order-first order-md-2'>
							<div className='txt-block right-column white-color wow fadeInLeft'>
								...
								{/* Title */}
								<h2 className='h2-xs'>
									Save your time and effort with Fix My Boat
									App
								</h2>
								{/* Text */}
								<p className='p-lg'>
									Quaerat sodales sapien euismod blandit at
									vitae ipsum primis undo and cubilia laoreet
									augue and luctus magna dolor luctus at
									egestas sapien vitae nemo egestas
								</p>
								{/* STORE BADGES */}
