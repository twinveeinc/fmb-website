					...
					<div className='row justify-content-center'>
						<div className='col-lg-10 col-xl-8'>
							<div className='section-title title-01 mb-80'>
								...
								{/* Text */}
								<p className='p-xl'>
									No credit card required. Change or cancel
									your plan anytime
								</p>
							</div>
						</div>
								...
								<div className='pricing-2-table bg-white mb-40 wow fadeInUp'>
									...
									<div className='pricing-plan'>
										...
										<div className='pricing-plan-title'>
											...
											<h6 className='h6-sm bg-lightgrey'>
												Save 30%
											</h6>
										</div>
										{/* Price */}
								...
								<div className='pricing-2-table bg-white mb-40 wow fadeInUp'>
									...
									<div className='pricing-plan highlight'>
										...
										<div className='pricing-plan-title'>
											...
											<h6 className='h6-sm bg-skyblue white-color'>
												Popular
											</h6>
										</div>
										{/* Price */}
						...
						<div className='col-lg-10 offset-lg-1'>
							<div className='pricing-notice text-center mb-40'>
								<p className='p-md'>
									...
									taxes based on your billing address. The
									final price will be displayed on the
									checkout page, before the payment is
									completed
								</p>
							</div>
						</div>
						...
						<div className='row row-cols-1 row-cols-md-3'>
							...
							<div className='col col-lg-4'>
								<div className='pbox mb-40'>
									...
									{/* Text */}
									<p>
										Explore OLMO Premium for 14 days. If
										it’s not a perfect fit, receive a full
										refund.
									</p>
								</div>
							</div>
							...
							<div className='col col-lg-3'>
								<div className='pbox mb-40'>
									...
									{/* Text */}
									<p>
										Your information is protected by 256-bit
										SSL encryption.
									</p>
								</div>
							</div>
							...
							<div className='row d-flex align-items-center'>
								...
								<div className='col-lg-7 col-lg-8'>
									<div className='cta-4-txt'>
										<h4 className='h4-xl'>
											Aliquam a augue suscipit, luctus
											neque purus
										</h4>
									</div>
								</div>
							...
							>
								...
								<div className='review-1'>
									...
									<div className='review-1-txt'>
										{/* Text */}
										<p className='p-lg'>
											Etiam sapien sagittis congue augue
											massa varius egestas ultrice varius
											magna a tempus aliquet undo cursus
											suscipit
										</p>
										{/* Testimonial Author */}
								...
								<div className='review-1'>
									...
									<div className='review-1-txt'>
										{/* Text */}
										<p className='p-lg'>
											At sagittis congue augue and egestas
											magna ipsum vitae a purus ipsum
											primis in cubilia laoreet augue
											egestas luctus and donec diam
											ultrice ligula magna suscipit lectus
											gestas augue into cubilia
										</p>
										{/* Testimonial Author */}
										<div className='author-data clearfix'>
											{/* Testimonial Avatar */}
								...
								<div className='review-1'>
									...
									<div className='review-1-txt'>
										{/* Text */}
										<p className='p-lg'>
											Mauris donec magnis sapien etiam
											sapien congue augue egestas et
											ultrice vitae purus diam integer a
											congue magna ligula undo egestas
								...
								<div className='review-1'>
									...
									<div className='review-1-txt'>
										{/* Text */}
										<p className='p-lg'>
											Mauris donec a magnis sapien etiam
											sapien congue augue pretium ligula
											lectus aenean a magna undo mauris
								...
								<div className='review-1'>
									...
									<div className='review-1-txt'>
										{/* Text */}
										<p className='p-lg'>
											An augue cubilia laoreet magna
											suscipit egestas and ipsum a lectus
											purus ipsum primis and augue ultrice
											ligula and egestas a suscipit lectus
											gestas undo auctor tempus feugiat
											impedit
										</p>
										{/* Testimonial Author */}
										<div className='author-data clearfix'>
								...
								<div className='review-1'>
									...
									<div className='review-1-txt'>
										...
										<p className='p-lg'>
											...
											ipsum semper suscipit egestas magna
											ipsum ligula a vitae purus and ipsum
								...
								<div className='review-1'>
									...
									<div className='review-1-txt'>
										{/* Text */}
										<p className='p-lg'>
											Augue egestas diam tempus volutpat
											egestas augue in cubilia laoreet
											magna suscipit luctus dolor and
											blandit vitae purus diam tempus an
								...
								<div className='review-1'>
									...
									<div className='review-1-txt'>
										{/* Text */}
										<p className='p-lg'>
											Augue at vitae purus tempus egestas
											volutpat augue undo cubilia laoreet
											magna suscipit luctus dolor blandit
											at purus tempus feugiat impedit
										</p>
										{/* Testimonial Author */}
										<div className='author-data clearfix'>
											{/* Testimonial Avatar */}
