	...
	return (
		...
		>
			<div className='faq-header'>
				{/* <img
					className='img-fluid'
					src='http://getyourezfill.com/wp-content/uploads/2021/08/faq.png'
					alt='faq heading'
					width='100%'
					height='auto'
				/> */}
				<div className='faq-header-textoverlay'>
					<h1>FAQ</h1>
					<p className='faq-overlay-subtag'>
								...
								<div class='accordion-item'>
									...
									>
										<div class='accordion-body'>
											...
											but just filling up the space to
											make it look, at least at first
											glance, a bit more representative of
											how this would look in a real-world
											application.
										</div>
									</div>
								</div>
